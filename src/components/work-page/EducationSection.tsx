    ...
    <section className='py-8 sm:py-12 md:py-16 lg:py-20'>
      <div className='max-w-[1120px] px-[22px] mx-auto'>
        <div className='mb-6 sm:mb-8 md:mb-10 lg:mb-12'>
          <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-global-2 mb-6 sm:mb-8 md:mb-10 lg:mb-12 font-product-sans'>
            Education
          </h2>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-16 xl:gap-20'>
            ...
            <div className='space-y-2 sm:space-y-3'>
              <h3 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-global-2 font-product-sans'>
            ...
            <div className='space-y-1 sm:space-y-2'>
              <h4 className='text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-global-2 font-product-sans'>
                {education.degree}
              </h4>
